...
export const Strategy = () => {
    return (
        <section className="bg-foreground text-white py-20 md:py-32 relative overflow-hidden" id="estrategia">
            ...
            <div className="hidden md:block absolute top-0 right-0 w-[500px] h-[500px] bg-primary/5 rounded-full blur-3xl -translate-y-1/3 translate-x-1/3" />
            ...
            <Section className="py-0 relative z-10">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-[1fr_auto] gap-12 items-end mb-16 md:mb-20">
                    ...
                    <AnimateInView direction="up" duration={800} delay={200} className="hidden lg:block">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    {/* Consultoria */}
                    <AnimateInView direction="left" duration={600}>
                        <div className="min-w-0 bg-white/5 border border-white/10 rounded-2xl p-8 md:p-10 flex flex-col gap-6 hover:bg-white/10 transition-colors duration-500">
                    ...
                    {/* Tráfego Pago */}
                    <AnimateInView direction="right" duration={600}>
                        <div className="min-w-0 bg-primary rounded-2xl p-8 md:p-10 flex flex-col gap-6 hover:bg-primary-dark transition-colors duration-500">
